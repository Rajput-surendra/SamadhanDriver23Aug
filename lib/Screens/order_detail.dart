        ...
        child: Padding(
            ...
            Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
              ...
              Padding(
                  ...
                  child: widget.model!.address == null ? Text("No address") : Text(capitalize(widget.model!.address!),
                  ...
                  child: Padding(
                      ...
                      child: Row(
                        children: [
                          ...
                          Text( widget.model!.mobile == null ? "" : " ${widget.model!.mobile!}",
                ...
                children: [
                  widget.model!.itemList![0].storeImage! == null ? Center(child: CircularProgressIndicator()) :   ClipRRect(
                      ...
                      child: widget.model!.itemList![0].storeImage! == null || widget.model!.itemList![0].storeImage! == "" ? Container() : FadeInImage(
                        ...
                        height: 90.0,
                        width: 90.0,
                        placeholder:AssetImage("assets/images/logo/normal_logo.png"),
                      )),
                  Expanded(
                      child: Column(
                        crossAxisAlignment: CrossAxisAlignment.start,
